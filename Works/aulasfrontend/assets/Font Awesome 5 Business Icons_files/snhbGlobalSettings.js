...
snhb.globalSettings = {  
    currencyConversionEURTo: {
        ...
        USD: { year: 2020, month: 06, rate: 1.1255 },
        AUD: { year: 2020, month: 06, rate: 1.6322 },
        NZD: { year: 2020, month: 06, rate: 1.7473 }
    },
    hbCPMMin: 0.05,
    bidderAdjustments: {
    ...
    ssr: {
        ...
        blacklist: ["snigelcampaign", "SekindoSPlayer", "live.sekindo.com", "connatix", "carambo.la", "vidazoo", "avantis", "avantisvideo"]
    },
    gdpr: {
